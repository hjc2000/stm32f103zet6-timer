...
{
    /// @brief 看门狗预分频器分频系数
    enum class IndependentWatchDogConfig_PrescalerOption
    {
...
#pragma region 分频系数
        /// @brief 看门狗预分频器分频系数。
        /// @return
        IndependentWatchDogConfig_PrescalerOption Prescaler() const;
        void SetPrescaler(IndependentWatchDogConfig_PrescalerOption value);
